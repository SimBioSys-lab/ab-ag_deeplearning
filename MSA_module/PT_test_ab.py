...
with open('mcabmodel_files', 'r') as f:
    models = [line.strip() for line in f if line.strip()]

# Test configuration
test_config = {
    'batch_size': 1,
    'sequence_file': 'antibody_test_sequences_2400.npz',
    'data_file': 'antibody_test_interfaces_2400.npz',
    'edge_file': 'antibody_test_edges_2400.npz',
    'max_len': 2400,
    'vocab_size': 23,
    'num_classes': 2
}
