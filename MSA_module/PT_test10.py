...
with open('gsd2_files', 'r') as f:
    models = [line.strip() for line in f if line.strip()]

# Test configuration
test_config = {
    'batch_size': 1,
    'sequence_file': 'selected_test_sequences_1600.npz',
    'data_file': 'selected_test_interface10_1600.npz',
    'edge_file': 'selected_test_edges_1600.npz',
    'max_len': 1600,
    'vocab_size': 23,
    'num_classes': 2
}
