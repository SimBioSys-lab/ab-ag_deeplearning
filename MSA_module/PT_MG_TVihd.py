...
config = {
    ...
    'data_file':      'ihd_train_esminterfaces10_1600.npz',
...
#    # Load parameters
#    core_params = torch.load('isicParamodelnewesm_l1_g10_i5_do0.1_dpr0.1_fold2_core.pth', map_location=device)
...
#    model.load_state_dict(model_state)
    ...
    ckpt=(f"iIHD10modelnewesm_l{config['num_layers']}_g{config['num_gnn_layers']}"
