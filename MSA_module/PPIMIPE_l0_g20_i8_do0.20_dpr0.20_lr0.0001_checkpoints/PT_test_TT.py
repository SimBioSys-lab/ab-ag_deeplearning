...
with open('best_files', 'r') as f:
    models = [line.strip() for line in f if line.strip()]

# Test configuration
test_config = {
    'batch_size': 1,
    'sequence_file': 'MIPE_test_sequences_1600.npz',
    'data_file': 'MIPE_test_interfaces_1600.npz',
    'edge_file': 'MIPE_test_edges_1600.npz',
    'max_len': 1600,
    'vocab_size': 23,
    'num_classes': 2
}
...
#    num_int_layers = int(parts[3][1:])
    ...
    embed_dim = 256
    num_heads = 16
#    drop_path_rate= float(parts[4][2:])
#    dropout = float(parts[5][3:])
    drop_path_rate= 0.2
    dropout = 0.2
