...
cfg = {
    # data / model
    'sequence_file':  'cleaned_para_tv_ag_sequences.npz',
    'data_file':      'cleaned_para_tv_ag_interfaces.npz',
    'edge_file':      'cleaned_para_tv_ag_edges.npz',
...
#    model.load_state_dict(model_state)
    ...
    name = (f"iParaagmodel_l{cfg['num_layers']}_g{cfg['num_gnn_layers']}"
