...
with open('pecan_newesm_i_files', 'r') as f:
    models = [line.strip() for line in f if line.strip()]

# Test configuration
test_config = {
    'batch_size': 1,
    'sequence_file': 'pecan_test_esmsequences_1600.npz',
    'data_file': 'pecan_test_esminterfaces_1600.npz',
    'edge_file': 'pecan_test_esmedges_1600.npz',
    'max_len': 1600,
    'vocab_size': 31,
    'num_classes': 2
}
