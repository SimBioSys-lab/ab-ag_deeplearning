...
config = {
    # data / model
    'sequence_file':  'MIPE_tv_esmsequences_ab_1600.npz',
    'data_file':      'MIPE_tv_esminterfaces_ab_1600.npz',
    'edge_file':      'MIPE_tv_esmedges_ab_1600.npz',
    'vocab_size':     31,
    'seq_len':        1600,
    'embed_dim':      256,
    'num_heads':      16,
...
#    model.load_state_dict(model_state)
    ...
    ckpt=(f"iMIPEabmodelnewesm_l{config['num_layers']}_g{config['num_gnn_layers']}"
