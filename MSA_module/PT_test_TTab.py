...
with open('paraab_newesm_i_files', 'r') as f:
    models = [line.strip() for line in f if line.strip()]

# Test configuration
test_config = {
    'batch_size': 1,
    'sequence_file': 'para_test_esmsequences_ab_1600.npz',
    'data_file': 'para_test_esminterfaces_ab_1600.npz',
    'edge_file': 'para_test_esmedges_ab_1600.npz',
    'max_len': 1600,
    'vocab_size': 31,
    'num_classes': 2
}
