...
from Models_dg import ClassificationModel
...
#    criterion = nn.CrossEntropyLoss(ignore_index=-1)
    ...
    if best_model_state is not None:
        torch.save(best_model_state, f'idgmodel_fold{fold}_l{config["num_layers"]}_g{config["num_gnn_layers"]}_i{config["num_int_layers"]}_dp{config["dropout"]}.pth')
