...
from Dataloader_SS_SASA import SequenceSecondaryStructureDataset  # Assuming your dataset class is defined here
from Models import SecondaryStructureModel  # Assuming your model class is defined here
...
config = {
    ...
    'num_classes': 8,  # Number of secondary structure classes
...
torch.save(pretrained_layers, 'pretrained_SS.pth')
