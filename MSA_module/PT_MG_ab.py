...
config = {
    'batch_size': 4,
    'sequence_file': 'antibody_train_sequences_2400.npz',
    'data_file': 'antibody_train_interfaces_2400.npz',
    'edge_file': 'antibody_train_edges_2400.npz',
    'max_len': 2400,
    'vocab_size': 23,
    'embed_dim': 256,
    'num_heads': 4,
...
#    model.load_state_dict(model_state)
    ...
    if best_model_state is not None:
        torch.save(best_model_state, f'PTabmodel_fold{fold}_l{config["num_layers"]}_g{config["num_gnn_layers"]}_i{config["num_int_layers"]}_dp{config["dropout"]}.pth')
