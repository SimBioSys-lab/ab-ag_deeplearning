...
config = {
    ...
    'data_file_train': 'cleaned_para_train_secondary_structure_1600.npz',
    'edge_file_train': 'cleaned_para_train_edges_1600.npz',
    'sequence_file_val': 'cleaned_para_val_sequences_1600.npz',
    'data_file_val': 'cleaned_para_val_secondary_structure_1600.npz',
...
# Load parameters
core_params = torch.load('imodelNM_l0_g20_i8_do0.10_dpr0.10_lr0.0002_fold3_core.pth', map_location=device)
...
for epoch in range(config['num_epochs']):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), f"ismodelNMNew45_l{config['num_layers']}_g{config['num_gnn_layers']}_i{config['num_int_layers']}_dp{config['dropout']}.pth")
